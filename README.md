...
Моя попытка описать паттерны микросервисов используя игру Factorio :). Основная проблема при изучении микросервисов в том, что они не наглядны, хоть и кажутся простыми для понимания. Тут же проблема масштабирования возникает **физически** - её можно увидеть, потрогать, и даже сыграть!
